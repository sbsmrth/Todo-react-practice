...
const Todo = ({ value, completed, deleteTodo, changeTodoState }) => {
  return (
    <li className="my-4 shadow-md shadow-secondary-blue py-4 px-4 flex justify-between rounded-lg items-center text-white">
      <button onClick={() => changeTodoState(value)}>  
        <Icon css={'sm:fa-lg hover:text-secondary-blue'} icon={faCheck}></Icon>
      </button>
